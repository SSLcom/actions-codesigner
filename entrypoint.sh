...
[ ! -z $INPUT_INPUT_FILE_PATH ] && COMMAND="${COMMAND} -input_file_path ${INPUT_INPUT_FILE_PATH}"
[ ! -z $INPUT_OUTPUT_DIR_PATH ] && COMMAND="${COMMAND} -output_dir_path ${INPUT_OUTPUT_DIR_PATH}"
